...
tool_path1="libs/jfuzzy.jar"

tool_path2="formula1-fuzzy.jar"
...
java -jar "$tool_path1" -e $file_path $fuel_level $race_position $race_progress $tire_condition

java -jar "$tool_path2" $file_path $fuel_level $race_position $race_progress $tire_condition
